/*
*  
*  Modifed for custom column numbers & outer margin. -b
*
...
/*  Create CSS */
    var styles = '\
        ...
        .ggs-0{left:0;}';
	    for (i=1; i<columns; i++) {
	    	var left = outerMargin + ( ( (100 - (outerMargin * 2)) / columns ) * i );
	    	styles += '.ggs-'+i.toString()+'{left:'+left.toString()+'%;}';
	    };
        styles += '.ggs-'+columns.toString()+'{right:0;}\
        .ggs-0,.ggs-'+columns.toString()+'{width:'+outerMargin.toString()+'%;padding-right:0.75em;border:0;margin:0;}\
        ...
        .ggs-'+columns.toString()+' div{left:0.75em;}\
